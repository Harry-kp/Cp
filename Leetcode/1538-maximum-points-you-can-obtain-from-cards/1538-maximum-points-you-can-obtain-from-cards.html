<h1>1538 - Maximum Points You Can Obtain from Cards</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/maximum-points-you-can-obtain-from-cards/">maximum-points-you-can-obtain-from-cards</a></h2><p>There are several cards <strong>arranged in a row</strong>, and each card has an associated number of points. The points are given in the integer array <code>cardPoints</code>.</p>
