<h1>1465 - Maximum Product of Splitted Binary Tree</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/maximum-product-of-splitted-binary-tree/">maximum-product-of-splitted-binary-tree</a></h2><p>Given the <code>root</code> of a binary tree, split the binary tree into two subtrees by removing one edge such that the product of the sums of the subtrees is maximized.</p>
