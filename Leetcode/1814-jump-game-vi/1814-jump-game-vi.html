<h1>1814 - Jump Game VI</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/jump-game-vi/">jump-game-vi</a></h2><p>You are given a <strong>0-indexed</strong> integer array <code>nums</code> and an integer <code>k</code>.</p>
