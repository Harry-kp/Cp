<h1>1005 - Univalued Binary Tree</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/univalued-binary-tree/">univalued-binary-tree</a></h2><p>A binary tree is <strong>uni-valued</strong> if every node in the tree has the same value.</p>
