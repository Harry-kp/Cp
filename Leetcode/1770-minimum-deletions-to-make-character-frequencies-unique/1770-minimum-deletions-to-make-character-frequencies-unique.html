<h1>1770 - Minimum Deletions to Make Character Frequencies Unique</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/minimum-deletions-to-make-character-frequencies-unique/">minimum-deletions-to-make-character-frequencies-unique</a></h2><p>A string <code>s</code> is called <strong>good</strong> if there are no two different characters in <code>s</code> that have the same <strong>frequency</strong>.</p>
