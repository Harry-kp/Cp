<h1>1823 - Determine if String Halves Are Alike</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/determine-if-string-halves-are-alike/">determine-if-string-halves-are-alike</a></h2><p>You are given a string <code>s</code> of even length. Split this string into two halves of equal lengths, and let <code>a</code> be the first half and <code>b</code> be the second half.</p>
