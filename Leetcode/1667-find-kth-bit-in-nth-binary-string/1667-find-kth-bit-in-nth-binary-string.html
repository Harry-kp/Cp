<h1>1667 - Find Kth Bit in Nth Binary String</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/find-kth-bit-in-nth-binary-string/">find-kth-bit-in-nth-binary-string</a></h2><p>Given two positive integers <code>n</code> and <code>k</code>, the binary string <code>S<sub>n</sub></code> is formed as follows:</p>
