<h1>1881 - Closest Subsequence Sum</h1><h2>Difficulty: Hard - <a href="https://leetcode.com/problems/closest-subsequence-sum/">closest-subsequence-sum</a></h2><p>You are given an integer array <code>nums</code> and an integer <code>goal</code>.</p>
